    ...
    public void selectItem(View view) {
        ...
        switch (view.getId()){
            case R.id.button_Chocolate:
                return_items_intent.putExtra(EXTRA_ITEMS, "Dairy Milk"); setResult(RESULT_OK, return_items_intent); finish();
                break;
            case R.id.button_oil:
                return_items_intent.putExtra(EXTRA_ITEMS, "Brownie"); setResult(RESULT_OK, return_items_intent); finish();
                break;
            ...
            case R.id.button_wheat:
                return_items_intent.putExtra(EXTRA_ITEMS, "Protein shake"); setResult(RESULT_OK, return_items_intent); finish();
                break;
            case R.id.button_bread:
                return_items_intent.putExtra(EXTRA_ITEMS, "Meat"); setResult(RESULT_OK, return_items_intent); finish();
                break;
            case R.id.button_sugar:
                return_items_intent.putExtra(EXTRA_ITEMS, "steak"); setResult(RESULT_OK, return_items_intent); finish();
                break;
